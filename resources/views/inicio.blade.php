...
@section('content')
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Autobuses, Alarmas, Rutas</p>
        </div>
    </header>
    ...
    <section class="page-section features" id="features">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto">
                        <img class="img-fluid" src="{{ asset('assets/img/portfolio/alerta.png') }}" alt="Bus 2" />
                    </div>
                    <div class="text-center mt-3">
                        <i class="fas fa-bell feature-icon"></i>
                        <h3 class="feature-title">Alarmas y Notificaciones</h3>
                        <p class="feature-description">Reciba alertas y notificaciones en tiempo real para un funcionamiento seguro y eficiente.</p>
                    </div>
                </div>
                <!-- Portfolio Item 3 -->
                <div class="col-md-6 col-lg-4 mb-5">
